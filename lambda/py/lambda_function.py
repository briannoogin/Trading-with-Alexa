...
class QuoteIntentHandler(AbstractRequestHandler):
    ...
    def can_handle(self, handler_input):
        # type: (HandlerInput) -> bool
        test = is_intent_name("QuoteIntent")(handler_input)
...
class NewsIntentHandler(AbstractRequestHandler):
    ...
    def handle(self, handler_input):
        ...
        logger.info("Got stock news of of {}".format(company))
...
class KeyStatsIntentHandler(AbstractRequestHandler):
    ...
    def can_handle(self, handler_input):
        # type: (HandlerInput) -> bool
        test = is_intent_name("KeyStatsIntent")(handler_input)
        logger.debug("The value of is_intent_name is {}".format(test))
    ...
    def handle(self, handler_input):
        ...
        message = data.KEYSTATS_MESSAGE.format(key_stats['companyName'], key_stats['week52high'], key_stats['week52low'],
                                               key_stats['week52change'], key_stats['latestEPS'],
                                               key_stats['latestEPSDate'], key_stats['peRatioHigh'],
                                               key_stats['peRatioLow'], key_stats['priceToSales'],
                                               key_stats['priceToBook'], key_stats['day200MovingAvg'],
...
class TrendStatsIntentHandler(AbstractRequestHandler):
    ...
    def handle(self, handler_input):
        ...
        message = data.TRENDSTATS_MESSAGE.format(trend_stats['companyName'], trend_stats['week52high'],
                                                 trend_stats['week52low'],
                                                 trend_stats['week52change'], trend_stats['EBITDA'],
                                                 trend_stats['day200MovingAvg'], trend_stats['day50MovingAvg'],
                                                 trend_stats['year5ChangePercent'], trend_stats['year2ChangePercent'],
                                                 trend_stats['year1ChangePercent'],
                                                 trend_stats['month6ChangePercent'], trend_stats['month3ChangePercent'],
...
class PriceIntentHandler(AbstractRequestHandler):
    ...
    def can_handle(self, handler_input):
        # type: (HandlerInput) -> bool
        test = is_intent_name("PriceIntent")(handler_input)
        logger.debug("The value of is_intent_name is {}".format(test))
